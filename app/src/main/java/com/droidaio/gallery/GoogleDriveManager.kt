...
/** Your backend endpoint that exchanges serverAuthCode for refresh/access tokens
...
object GoogleDriveManager {
    ...
    private const val DRIVE_UPLOAD_URL = "@string/GDriveUploadUrl"
    private const val GOOGLE_CLIENT_ID = "@string/GDriveClientId"
    private const val SERVER_TOKEN_EXCHANGE_URL_KEY = "@strings/token_Xchange"
